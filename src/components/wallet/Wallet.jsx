        ...
        <Row className="justify-content-center">
          <Col lg="8">
            <Row className="align-items-center">
              <Col lg={12} className="order-2 order-lg-1 mt-5 mt-lg-0" id="stake">
                      ...
                      <table class="table table-sm table-bordered flexible-bottom-content1 mb-0 mt-4" id="tabs">
                        <thead>
                          <tr >
                            ...
                            <th style={{ color: "white", textAlign: "center" , fontSize: "15px"}}>Stake Date</th>
                            <th style={{ color: "white", textAlign: "center" , fontSize: "15px"}}>Stake Amount</th>
                            <th style={{ color: "white", textAlign: "center" , fontSize: "15px"}}>Unlock Date</th>
